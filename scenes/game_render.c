...
void game_render_world(GameState *game) {
    ...
    /////
    DrawText(TextFormat("vx: %.1f  onGround: %d  vy: %.1f  groundIdx: %d", game->player.vx, game->player.onGround, game->player.vy, game->player.groundPlatformIndex), 20, 72, 14, LIME);
    #endif
